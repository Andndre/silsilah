...
<div id="{idParent}" class={cn("flex flex-col gap-20 relative node", className)} style="align-items: safe center;">
	<!-- Parent node -->
	<div class={cn("p-2 rounded-3xl border-2 border-black bg-gray-200 flex flex-col items-center gap-2", asChild ? 'connector-top' : '', schema.children.length > 0 ? 'connector-bottom' : '')}>
